...
def copy_to_bucket(bucket_from_name, bucket_to_name, src_prefix, file_name):
...
# print(data_bucket_name)
copy_to_bucket(source_bucket, data_bucket_name, src_prefix='stock_deepar/json/valid', file_name='IBM.json')
copy_to_bucket(source_bucket, data_bucket_name, src_prefix='stock_deepar/json/valid', file_name='AAPL.json')
copy_to_bucket(source_bucket, data_bucket_name, src_prefix='stock_deepar/json/valid', file_name='AMZN.json')
copy_to_bucket(source_bucket, data_bucket_name, src_prefix='stock_deepar/json/valid', file_name='GOOGL.json')
...
ibm_json = get_json_stock_data('IBM', s3_resource, data_bucket_name)
aapl_json = get_json_stock_data('AAPL', s3_resource, data_bucket_name)
amzn_json = get_json_stock_data('AMZN', s3_resource, data_bucket_name)
googl_json = get_json_stock_data('GOOGL', s3_resource, data_bucket_name)
print(ibm_json)
print(aapl_json)
print(amzn_json)
print(googl_json)
